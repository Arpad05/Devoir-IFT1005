...
function removeItem(){
    ...
    if (confirm("Voulez-vous supprimer le produit du panier ?")){
        ...
        $('table').on('click', '.remove-item-button', function(event){
            itemName = $(this).closest('td').next().children().html();
...
function showShoppingCart(){
    ...
    function fillShoppingCart(value, index, array){
        ...
        '<td><div class=\"row\"><div class=\"col\"><button title=\"Retirer\"><i class=\"fa fa-minus\"></i></button></div><div class=\"col\">' 
        + jsonItem.quantity
    ...
    window.localStorage.setItem('totalPrice', totalItemsPrice.toString());
